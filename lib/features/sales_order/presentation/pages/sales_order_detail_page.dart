...
class _SalesOrderDetailPageState extends ConsumerState<SalesOrderDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final DateFormat dateFormatter = DateFormat.yMMMd(locale).add_jm();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDetailRow(context, '账期 (天):', order.creditPeriod.toString(), icon: Icons.timer_outlined),
                const SizedBox(height: 10),
